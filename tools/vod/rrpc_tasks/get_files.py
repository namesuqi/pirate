...
def get_files_info_with_rename_key():
    # sql = "select hex(file_id) AS file_id, fsize AS file_size, psize AS piece_size, ppc from boss.ppc_tenant_files"
    sql = 'select hex(ppc_tenant_files.file_id) AS file_id, ppc_tenant_files.fsize AS file_size,' \
          ' ppc_tenant_files.psize AS piece_size, ppc_tenant_files.ppc AS ppc, ' \
          'ppc_tenant_source.source_type AS source_type from boss.ppc_tenant_files, ppc_tenant_source ' \
          'where ppc_tenant_source.id=ppc_tenant_files.sid;'
