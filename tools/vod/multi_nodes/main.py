...
--------------------------
cd pirate
python tools/vod/multi-nodes/main.py <operation> <host.ini>
<operation>:
...
class RemoteNode(object):
    ...
    def start_play(self):
        ...
        command = "cd {player} ; nohup python {player}/local_main.py --num {num} --url {url} --action start_play> " \
                  "local_main.log 2>&1 &".format(
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        elif sys.argv[1] == "start_play":  # play channel
