...
if __name__ == "__main__":
    # topic_list = ["vod_sdk_file_status", "vod_sdk_lsm", "vod_peer_info", "vod_push_disk_cache", "vod_push_lsm",
    #               "vod_fod_report", "vod_all_files", "task_vod_push_prefetch", "task_vod_push_delete",
    #               "task_vod_sdk_download", "task_vod_sdk_delete"]
